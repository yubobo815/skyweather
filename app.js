...
const translations = {
  en: {
    ...
    comfort: {
      ...
      muggy: "Muggy",
      dry: "Dry",
      summary: "Feels {feels} · Humidity {humidity}",
    },
    unavailable: "Unavailable",
    currentLocation: "Current Location",
    currentLocationWithCoords: "Current location ({latitude}, {longitude})",
    dataAttribution: "Forecast data by {openMeteo}. Postal lookup by {zippopotam}. Location details by {bigDataCloud} and {nominatim}. Weather radar by {rainViewer}. Weather icons by {meteocons}.",
    status: {
  ...
  zh: {
    ...
    comfort: {
      ...
      muggy: "闷热",
      dry: "偏干",
      summary: "体感 {feels} · 湿度 {humidity}",
    },
    unavailable: "暂无数据",
    currentLocation: "当前位置",
    currentLocationWithCoords: "当前位置（{latitude}, {longitude}）",
    dataAttribution: "天气预报来自 {openMeteo}。邮编查询来自 {zippopotam}。位置详情来自 {bigDataCloud} 和 {nominatim}。天气雷达来自 {rainViewer}。天气图标来自 {meteocons}。",
    status: {
      addSearch: "请先输入邮编或城市。",
